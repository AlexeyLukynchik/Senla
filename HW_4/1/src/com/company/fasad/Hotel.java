...
///////////////////
        ...
        ManagerHistoryService managerHistoryService = new ManagerHistoryService();
...
//repoService.writeToFile(parserToString.parseRepoService(repositoryService,arrayWorker));
        ...
        //  RepositoryHistoryHotel repositoryHistoryHotel = new RepositoryHistoryHotel();
        managerRoom.occupance(reposClientclient.getClients()[0], room, room.getRooms()[0].getNumber(), arrayWorker, historyHotel);
       ...
       /* Arrays.sort(room.getRooms(), new ComparatorByPrice());
        ...
        managerRoom.sortRoom(room, new ComparatorByCapacity());
        ...
        managerRoom.returnListWillFree(room, date);
