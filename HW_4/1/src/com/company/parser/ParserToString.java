...
public String[] parseClient(RepositoryClient repositoryClient,String surname, ArrayWorker arrayWorker){
    ...
    String[] obj = new String[4];
if(repositoryClient.getClients()[number].getID() == null){
        obj[0] = "null";
    }else

{obj[0] = repositoryClient.getClients()[number].getID().toString();}
    ...
    */
    public String[] parseRepositoryHistory(RepositoryHistoryHotel historyHotel, ManagerHistoryService service) {
        ...
        for (int i = 0; i < historyHotel.getHistoryHotels().length; i++) {
            System.arraycopy(parseHistoryHotel2(historyHotel.getHistoryHotels()[i], service, historyHotel), 0, str, count, 4);
            count = count + 8;
        }
        return str;
    ...
    public String[] parseHistoryHotel2(HistoryHotel hotel, ManagerHistoryService service, RepositoryHistoryHotel historyHotel) {
        ...
        obj[2] = parseService(hotel.getServices(), service.returnCountHistory(historyHotel));
        obj[3] = parseDateService(hotel.getServices(),service.returnCountHistory(historyHotel));
    ...
    Integer number;
        ...
        obj[0] = historyHotel.getHistoryHotels()[number].getID().toString();
