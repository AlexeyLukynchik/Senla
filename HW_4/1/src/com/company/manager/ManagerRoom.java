...
public class ManagerRoom {
    ...
    public RepositoryRoom occupance(Client client, RepositoryRoom repositoryRoom, Integer integer, ArrayWorker arrayWorker, HistoryHotel historyHotel) {
        ...
        changeStatus(repositoryRoom.getRooms()[trueNumber], "busy");
    ...
    public Room[] sortRoom(RepositoryRoom room, Comparator comparator) {
    ...
    public void returnListWillFree(RepositoryRoom repositoryRoom, Date date) {
        ...
        for (int i = 0; i < repositoryRoom.getRooms().length; i++) {
            ...
            if (date.before(repositoryRoom.getRooms()[i].getDateEviction()) == true) {
    ...
    public void changeStar(RepositoryRoom repositoryRoom, Integer newStar, Integer num, ArrayWorker arrayWorker) {
        ...
        switch (newStar) {
            ...
            case 4:
                ...
                break;
            case 5:
                repositoryRoom.getRooms()[trueNumber].setCountStars(Star.FIVE.getValue());
                break;
            default:
